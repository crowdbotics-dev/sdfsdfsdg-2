"""
Django settings for sdfsdfsdg_2 project.
...
WSGI_APPLICATION = 'sdfsdfsdg_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sdfsdfsdg_2 API",
    "DESCRIPTION": "API documentation for sdfsdfsdg_2 App",
    "VERSION": "v1",
}
